...
<head>
  ...
  <title>${title}</title>
  <meta name="description" content="TypeScript operator surface for editorial standards routing, copy-policy blockers, and approval-safe publishing posture. Operator surface in the Kinetic Gain Suite." />
  ...
  <link rel="canonical" href="https://editorial.kineticgain.com/" />
  <link rel="icon" type="image/svg+xml" href="${KG_FAVICON_DATA_URI}" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Kinetic Gain" />
  <meta property="og:title" content="${title}" />
  <meta property="og:url" content="https://editorial.kineticgain.com/" />
  <meta property="og:description" content="TypeScript operator surface for editorial standards routing, copy-policy blockers, and approval-safe publishing posture. Operator surface in the Kinetic Gain Suite." />
  <meta name="twitter:card" content="summary" />
  <meta name="twitter:title" content="${title}" />
  <meta name="twitter:description" content="TypeScript operator surface for editorial standards routing, copy-policy blockers, and approval-safe publishing posture. Operator surface in the Kinetic Gain Suite." />
  <script type="application/ld+json">{"@context":"https://schema.org","@graph":[{"@type":"ProfessionalService","@id":"https://editorial.kineticgain.com/#service","name":"Kinetic Gain — TypeScript operator surface for editorial standards routing, copy-policy blockers, and approval-safe publishing posture","url":"https://editorial.kineticgain.com/","areaServed":"United States","description":"TypeScript operator surface for editorial standards routing, copy-policy blockers, and approval-safe publishing posture. Operator surface in the Kinetic Gain Suite."},{"@type":"WebSite","@id":"https://editorial.kineticgain.com/#website","url":"https://editorial.kineticgain.com/","name":"TypeScript operator surface for editorial standards routing, copy-policy blockers, and approval-safe publishing posture","publisher":{"@type":"Organization","name":"Kinetic Gain LLC"}}]}</script>
  <style>${KG_STYLE01_CSS}${KG_COMPAT_CSS}</style>
</head>
<body>
  <header>
    <div class="wrap nav">
      <a class="kg-logo" href="/" aria-label="Kinetic Gain — TypeScript operator surface for editorial standards routing, copy-policy blockers, and approval-safe publishing posture">
        ${KG_MARK_SVG}
        <span class="kg-word">Kinetic Gain</span>
      </a>
      <nav class="nav-links" id="primaryNav">
        <a href="/editorial-lane">Editorial Lane</a>
        <a href="/standards-gaps">Standards Gaps</a>
    ...
    <div class="wrap">
      <div class="foot-top">
        <div>
          ...
          <p class="foot-tag">TypeScript operator surface for editorial standards routing, copy-policy blockers, and approval-safe publishing posture — operator surface in the Kinetic Gain Suite. Static demo data; no live calls.</p>
        </div>
        <div class="foot-cols">
          <div class="foot-col">
            <h4>Estate</h4>
          ...
          <div class="foot-col">
            <h4>This surface</h4>
            <a href="https://github.com/mizcausevic-dev/editorial">GitHub repo</a>
          </div>
        </div>
      </div>
      <div class="foot-bot">
...
function heroShell(active: string, content: string) {
  return `${renderHero(active)}${content}
    <footer>
      <div>editorial-standards-approval-desk · synthetic demonstration data only</div>
